const addresses = {
  ...
  "000079":
    "Networth Incorporated	[bought by Compaq, used in Netelligent series]",
  "00007A": "Ardent",
  ...
  "000083":
    "Tadpole Technology  [had Optical Data Systems which is wrong according to both]",
  ...
  "000101": "Private",
  "000102":
    "BBN (Bolt Beranek and Newman, Inc.)	internal usage (not registered)",
  ...
  "000C4D":
    "Curtiss-               # Curtiss-Wright Controls Avionics & Electronics",
  ...
  "001576":
    "Labitec-               # LABiTec - Labor Biomedical Technologies GmbH",
  ...
  "002025":
    "Control Technology Inc (Industrial Controls and Network Interfaces)",
  ...
  "002035":
    "IBM (International Business Machines)	mainframes, Etherjet printers",
  "002036": "BMC Software",
  ...
  "004004": "ICM CO. LTD.",
  "004005":
    "TRENDware International Inc.; Linksys; Simple Net; all three reported",
  ...
  "004090":
    "Ansel Communications	PC NE2000 compatible twisted-pair ethernet cards",
  ...
  "00A0C8": "Adtran, Inc.",
  "00A0C9":
    "Intel (PRO100B and PRO100+)	[used on Cisco PIX firewall among others]",
  ...
  "00C094": "VMX INC.",
  "00C095":
    "Znyx (Network Appliance); Jupiter Systems (MX-700); Apple (G3)  all seen",
  ...
  "080017":
    "National Semiconductor Corp. (used to have Network System Corp., wrong NSC)",
  ...
  "4C60DE": "Netgear",
  "4C6255":
    "Sanmina-               # SANMINA-SCI SYSTEM DE MEXICO S.A. DE C.V.",
  ...
  "8CA2FD": "Starry, Inc.",
  "8CA5A1":
    "Oregano-               # Oregano Systems - Design & Consulting GmbH",
...
const sanitize = (string) => {
  return forbiddenValues.reduce((acc, curr) => {
    return acc.replaceAll(curr, "").toUpperCase();
  }, string);
};

const fetchVendor = (address) => {
  const sanitized = sanitize(address);
  const blockId = sanitized.slice(0, 6);
  const vendor = addresses[blockId];
  return vendor || "unknown MAC address";
};
...
const loopThrough = (item) => {
  if (item.children && item.children.length > 0) {
    ...
    const macAdresses = item.textContent.matchAll(
      /([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})/g
    );

    for (address of macAdresses) {
      const add = address[0];
      const a = document.createElement("a");
      const vendor = fetchVendor(add);
      a.textContent = `${vendor}`;
      a.classList.add("mac-mapper-address");
      item.insertAdjacentElement("afterend", a);
      a.href = `https://maclookup.app/search/result?mac=${add}`;
    }
  }
};
